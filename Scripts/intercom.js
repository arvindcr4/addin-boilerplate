!function() {
    ...
    !function() {
        "use strict";
        var e = /iphone|ipad|ipod|android|blackberry|opera mini|iemobile/i,
            t = [".intercom-lightweight-app-launcher", ".intercom-launcher-frame", "#intercom-container", ".intercom-messenger", ".intercom-notifications"];
        function r(e) {
            try {
                if (!(e in window))
                    return !1;
        ...
        var p = function(e) {
            ...
            f = l + "frame.6c0060df.js",
            w = l + "vendor.f14253c2.js",
            h = l + "frame-modern.f7cb8b65.js",
            v = l + "vendor-modern.353a08a0.js",
            g = "Intercom",
            ...
            A = function() {
                ...
                o() && n.setAttribute("style", n.getAttribute("style") + "visibility: hidden;"),
                ...
                var r,
                    ...
                    a = p(i ? h : f),
                    s = p(i ? v : w);
                return n.contentDocument.head.appendChild(a), n.contentDocument.head.appendChild(s), window.__intercomAssignLocation = function(e) {
                    window.location.assign(e)
                }, window.__intercomReloadLocation = function() {
            ...
            _ = function() {
                ...
                delete window.__intercomReloadLocation
            },
            x = function() {
                if (!window[g]) {
                    var e = function e() {
